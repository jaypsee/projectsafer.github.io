...
! function($) {
	...
	Sidemenu.prototype.init = function() {
		...
		$("#main-menu ul li.menu-item a.active").parents("li:last").children("a:first").addClass("active").trigger("click");
	},
...
$(document).ready(function() {
	...
	var $sidebarOverlay = $(".main-menu-overlay");
